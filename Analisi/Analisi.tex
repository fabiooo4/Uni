...
\begin{enumerate}
    ...
    \item Se \( k \in \mathbb{R} \) è una costante,
        \[
        ko(g(x)) = o(g(x))\;\;\;\;\;\; per\; x \to x_0
        \] 
    \item \( f(x)o(g(x)) = o(f(x)g(x))\;\;\;\;\;\; per\; x \to x_0 \) 
\end{enumerate}
\begin{example}
    \[
    \lim_{x \to 0} \frac{x sin(x) - x^5}{3x^2 + x^3} \;\;\;\;FI (\frac{0}{0})
    \] 
    \[
        \frac{xsin(x)-x^5}{3x^2 + x^3} \underbrace{=}_{sin(x) = x + o(x) \;\; per\; x \to 0} \frac{x(x+o(x)) - x^5}{3x^2+x^3}
    \] 
    \[
    = \frac{x^2 + o(x^2) - x^5}{3x^2+x^3}
    \] 
    \[
    = \frac{1 + o(1) - x^3}{3+x} = \lim_{x \to 0} = \frac{1}{3}
    \] 
\end{example}
\end{document}
