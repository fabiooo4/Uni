  ...
  \begin{example}
    \begin{figure}[H]
      ...
      \begin{tikzpicture}
        ...
        \draw[green,thick,domain=0:5.9,smooth,samples=100] plot ({\x},{1 - exp(-0.1 * 6.2 * \x)* cos(-10 * \x r)});
        ...
        \node[align=center] at (7,1.5) {\color{green}Oscilla\\\color{red}Veloce\\\color{orange}Lento};
      \end{tikzpicture}
...
\begin{itemize}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=1.5]
      ...
      \draw[green,thick] (-0.2,-0.2) node[below] {a} -- ++(0.4,0) node[below,scale=0.8] {b}
