...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[->] (0,-1.5) -- (0,1.5) node[above] {$x(k)$};
    \draw[blue,domain=-3:3,samples=100] plot ({\x},{sin(\x*5 r)});
  \end{tikzpicture}
  \label{10-10-D1}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \draw[->] (-3,0) -- (3,0) node[right] {$k$};
    \draw[->] (0,-1.5) -- (0,1.5) node[above] {$x(k)$};
    \draw[domain=-3:3,smooth,variable=\x,green,thin,samples=100] plot ({\x},{sin(\x*5 r)}) node[above right, green] {Inviluppo};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[->] (0,-0.2) -- (0,3) node[above] {$A$};
    \draw[domain=-3:1.1,smooth,variable=\x,blue] plot[ycomb] ({\x},{exp(\x)}) node[above right, scale=0.9,align=center] {$\alpha > 0$\\$|\alpha| > 1$};
  \end{tikzpicture}
\end{figure}
\label{10-10-D5}
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \draw[->] (-3,0) -- (3,0) node[right] {$n$};
    \draw[->] (0,-0.2) -- (0,3) node[above] {$A$};
    \draw[domain=-1.1:3,smooth,variable=\x,cyan] plot[ycomb] ({\x},{exp(-\x)}) node[above right, scale=0.9,align=center] {$\alpha > 0$\\$|\alpha| < 1$};  \end{tikzpicture}
\end{figure}
\label{10-10-D6}
