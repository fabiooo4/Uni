...
\begin{enumerate}
  \item \textbf{Blocco sequenziale}: un tipico blocco di codice eseguito sequenzialmente
...
le unisce in modo ordinato. La complessità, considerando il merge con complessità lineare,
risulta:
\[
