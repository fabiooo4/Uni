...
\begin{enumerate}
  \item 
    ...
    il numero di host totale delle 3 LAN:
    \[
      300 + 40 + 90 = 430
    \] 
    Il blocco CIDR che riesce a contenere 430 host è:
    \[
      2^9 = 512
    \] 
    Bisogna però raddoppiarlo perchè la rete si vuole dividere in sottoreti, quindi
    bisogna riservare un bit per indicare la sottorete:
    \[
      2^{10} = 1024
    \] 
  ...
  \item 
    ...
    \[
      \begin{aligned}
        ...
        \text{LAN 2: } &
        \underbrace{1001 0100 \;\; 0000 1100 \;\; 0100 11}_{\text{Prefisso}}
        \;\; \underbrace{00\;\;00}_{\text{Lan 2}}
        \;\; \underbrace{000000}_{\text{Suffisso}}\\
        \text{LAN 3: } &
        \underbrace{1001 0100 \;\; 0000 1100 \;\; 0100 11}_{\text{Prefisso}}
        \;\; \underbrace{00\;\;0}_{\text{Lan 3}}
    ...
    \begin{aligned}
      ...
      \text{LAN 2: } & 148.12.76.0/26\\
      \text{LAN 3: } & 148.12.76.0/25
    \end{aligned}
    \] 
\end{enumerate}
