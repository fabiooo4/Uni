...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../figures/livello2-es1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../figures/livello2-es2}
\end{figure}
Alla prima collisione:
\[
  \begin{aligned}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../figures/bridge-es1}
\end{figure}
\noindent
Alla prima collisione:
\[
