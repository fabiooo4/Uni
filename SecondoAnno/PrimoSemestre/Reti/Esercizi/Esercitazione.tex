...
\[
  \begin{aligned}
    ...
    SSTHRESH &= \frac{20}{2} = 10 \text{ segmenti}
  \end{aligned}
\] 
L'evoluzione della finestra di congestione è la seguente:
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw[orange] (0,10*\yscale) node[above right] {\texttt{ssthresh}} -- (5*\xscale,10*\yscale)
      -- (9*\xscale,10*\yscale) -- (9*\xscale,6*\yscale)
      -- (15*\xscale,6*\yscale) -- (15*\xscale,4*\yscale)
      -- (19*\xscale,4*\yscale) -- (19*\xscale,1*\yscale)
      -- (\xaxis*\xscale+1*\xscale,1*\yscale);
    ...
    \fill[blue] (4*\xscale,10*\yscale) circle (0.05) node[scale=0.1] (5) {};
    \fill[blue] (5*\xscale,11*\yscale) circle (0.05) node[scale=0.1] (6) {};
    \fill[blue] (6*\xscale,12*\yscale) circle (0.05) node[scale=0.1] (7) {};
    \fill[blue] (7*\xscale,13*\yscale) circle (0.05) node[right,red] {\( \times \)} node[scale=0.1] (8) {};
    \draw[blue] (1) -- (2) -- (3) -- (4) -- (5) -- (8);

    % Loss
    \draw[purple,dashed] (7*\xscale,13*\yscale) -- (9*\xscale,13*\yscale) node[above] {\texttt{RTO}} -- (9*\xscale,1*\yscale);
    ...
    \fill[blue] (12*\xscale,6*\yscale) circle (0.05) node[scale=0.1] (12) {};
    \fill[blue] (13*\xscale,7*\yscale) circle (0.05) node[right,red] {\( \times \)} node[scale=0.1] (13) {};
    \draw[blue] (9) -- (10) -- (11) -- (12) -- (13);

    % Loss
    \draw[purple,dashed] (13*\xscale,7*\yscale) -- (15*\xscale,7*\yscale) -- (15*\xscale,1*\yscale);
    ...
    \fill[blue] (29*\xscale,3*\yscale) circle (0.05) node[scale=0.1] (18) {};
    \fill[blue] (30*\xscale,4*\yscale) circle (0.05) node[scale=0.1] (19) {};
    \fill[blue] (31*\xscale,5*\yscale) circle (0.05) node[scale=0.1] (20) {};
    \fill[blue] (32*\xscale,6*\yscale) circle (0.05) node[scale=0.1] (21) {};
    \fill[blue] (33*\xscale,7*\yscale) circle (0.05) node[scale=0.1] (22) {};
    \fill[blue] (34*\xscale,7*\yscale+5/7*\yscale) circle (0.05) node[above] {\( 7+\frac{5}{7} \) } node[scale=0.1] (23) {};
    \draw[blue] (16) -- (22) -- (23);


    % End
    % \draw[dashed] (20*\xscale,4*\yscale+3/8) -- (20*\xscale,0) node[below,align=center,scale=0.8] {Fine\\trasmissione};
...
Il numero di segmenti trasmessi è:
\[
  \#seg = 1+2+4+8+10+11+12+\cancel{13}+1+2+4+6+\cancel{7}+\cancel{1}+\cancel{1}+1+2+3+4+5+6+5
\] 
\[
= 87
\] 
