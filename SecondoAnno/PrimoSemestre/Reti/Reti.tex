...
\end{figure}
oppure si può rappresentare anche:
\begin{figure}[H]
  \centering
  \begin{tikzpicture}
...
\[
  \underbrace{10011101 \;\; 00011011}_{n} \;\; \underbrace{0001 \; 0011 \;\; 0111 \; 1011}_{32 - n}
\] 
...
ad esempio:
\[
/16 \to 1111 \; 1111 \; 1111 \; 1111 \; 0000 \; 0000 \; 0000 \; 0000
\] 
Questa sequqnza è chiamata \textbf{maschera} perchè è abbinata all'indirizzo IP.
\begin{example}
\[
  \begin{aligned}
    \text{IP: } & 10011101 \;\; 00011011 \;\; 0001 \; 0011 \;\; 0111 \; 1011\\
    \text{Mask: }& \underbrace{11111111 \;\; 11111111}_{\text{Prefisso}} \;\; \underbrace{0000 \; 0000 \;\; 0000 \; 0000}_{\text{Suffisso}}
  \end{aligned}
\] 
\end{example}
Facendo l'end bit a bit tra l'IP e la maschera si ottiene l'indirizzo di rete a cui
