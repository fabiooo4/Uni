...
public class SimpleMachine implements Machine {
	 ...
	 * @throws IllegalProgramException se l'esecuzione del programma fallisce per
	 *                                 qualche motivo
	 */
	...
	/**
	 * Esegue le istruzioni del programma, dall'inizio alla fine, partendo da uno
	 * stack vuoto. Dopo avere eseguite tutte le istruzioni, restituisce l'elemento
	 * in cima allo stack risultante alla fine.
	 * 
	 * @param program il programma da eseguire
	 * @return l'elemento che c'e' in cima allo stack alla fine dell'esecuzione del
	 *         programma
	 * @throws IllegalProgramException se l'esecuzione del programma va in errore
	 *                                 oppure se alla fine dell'esecuzione lo stack
	 *                                 e' vuoto (e quindi non c'e' nessun elemento
	 *                                 in cima da potere ritornare)
	 */
