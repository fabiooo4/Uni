...
\begin{example}
  ...
  \[
    \Phi (\vec{E}) = \Phi_{\text{Basi}} + \Phi_{\text{Laterale}} = E \cdot 2 \pi r h =
...
\end{example}
\begin{example}
  Consideriamo una carica \( \sigma^+ \) distribuita su un cilindro di raggio \( R \):
  \label{19-03-D9}
  ...
  \[
    E(r) = \begin{cases}
      \frac{\sigma}{2 \varepsilon_0 Rr} & \text{se } r \ge R\\
      0 & \text{se } r < R
    \end{cases}
  \]
  Il grafico del campo elettrico è:
