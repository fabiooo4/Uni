...
sulle cariche della spira che le mette in moto. Se invece è il campo magnetico a muoversi
...
\begin{itemize}
  ...
  \item Variare l'angolo \( \theta \) tra il campo magnetico e la superficie
\end{itemize}
