...
distanza molto lontana e di considerare le altre cariche come cariche che si muovono.
...
La proprietà importante è che il campo è definito anche se altre cariche non sono presenti.
...
\begin{definition}
  ...
  \[
    \vec{E} \left( \vec{r} \right) = \frac{Q}{4 \pi \varepsilon_0} \cdot \frac{\hat{r}}{r^2}
