...
Il problema dei cammini minimi è quello di trovare il cammino più breve
tra 2 nodi di un grafo. Il problema è definito su un grafo orientato e pesato.
Un arco è rilassabile se la relax su quell'arco porta ad un miglioramento. In un albero
di cammini minimi nessun arco è rilassabile perchè tutti i cammini sono già minimi.
