...
\vspace{1em}
\noindent
Il teorema di Max-Flow Min-Cut afferma che il flusso massimo è uguale alla capacità
del taglio minimo.
...
\begin{figure}[H]
  ...
  \begin{tikzpicture} [
    ...
    \node[draw,circle,minimum size=0.8cm] (u) {u};
    \node[draw,circle,minimum size=0.8cm] (v) [right=of u] {v};
    \node[above] at (u.north) {\( \delta(u) \)};
    \node[above] at (v.north) {\( \delta(u) + 1 \)};
    \node[below] at (u.south) {\( \delta'(v) \ge \delta(u) + 1 \)};
    \node[below] at (v.south) {\( \delta'(v) + 1 \ge \delta(u) + 2 \)};

    \draw[->] (u) edge[bend left=20] (v);
    \draw[<-,dashed] (u) edge[bend right=20] (v);
  \end{tikzpicture}
\end{figure}
\noindent
...
\begin{example}
  ...
  \begin{figure}[H]
    \centering
    \begin{tikzpicture}
      \draw[->] (0,0) -- (5,0) node[below] {x1};
      \draw[->] (0,0) -- (0,5) node[left] {x2};

      \draw[thick,blue] (0,4) -- (4,0);
      \draw[thick,green!50!black] (2,3) -- (2,0);
      \draw[thick,purple] (2,3) -- (0,3);
      ...
      \fill[green,opacity=0.2] (0,0) -- (0,3) -- (1,3) -- (2,2) -- (2,0) -- cycle;
    \end{tikzpicture}
  ...
  \begin{figure}[H]
    ...
    \begin{tikzpicture}
      ...
      \draw[green!50!black] (0,0) -- (0,3) -- (1,3) -- (2,2) -- (2,0) -- cycle;
      \fill[green,opacity=0.2] (0,0) -- (0,3) -- (1,3) -- (2,2) -- (2,0) -- cycle;

      \draw[thick,red] (0,3.15) -- (5,2.5) node[above] {$x_1 + 6x_2$};
