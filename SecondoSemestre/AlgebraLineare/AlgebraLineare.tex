...
\begin{figure}[H]
	\begin{definition}
		...
		\]
		\[
			\alpha = \arctan\left(\frac{b}{a}\right) \quad \text{se} \; a > 0,\; b > 0
		\]
		\[
			\alpha = \arctan\left(\frac{b}{a}\right) + \pi \quad \text{se} \; a > 0, b < 0
		\]
		\[
			\alpha = \arctan\left(\frac{b}{a}\right) - \pi \quad \text{se} \; a < 0, \; b \; \text{qualsiasi}
		\]
		\[
			\alpha = \frac{\pi}{2} \quad \text{se} \; a = 0, \; b > 0
		\]
		\[
			\alpha = -\frac{\pi}{2} \quad \text{se} \; a = 0, \; b < 0
		\]
