...
\begin{figure}[H]
  \begin{center}
    \begin{tikzpicture}[scale=0.8]
      ...
      \draw [green, ultra thick] plot coordinates { (0,1) (8,1) (8,2) (9,2) (9,1) (12,1) };
      ...
      \node[green, anchor=east] at (0,1) {\( \overline{BBSY} \) };
    \end{tikzpicture}
  \end{center}
...
\subsection{Bus}
I bus sono delle linee di comunicazione che collegano i vari componenti di un sistema
informatico. I bus possono essere divisi in:
...
\subsubsection{Multitasking (multiprocesso)}
