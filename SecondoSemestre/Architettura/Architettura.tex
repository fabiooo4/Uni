...
\begin{figure}[H]
  ...
  \centering
  \begin{tikzpicture}
    \draw (0,0) rectangle (1,1) node[midway] {Fetch};
    \draw (2,0) rectangle (3,1) node[midway] {Decode};
    \draw (4,0) rectangle (5,1) node[midway] {Execute};
    \draw (6,0) rectangle (7,1) node[midway] {Write};

    \draw (1.25,1.5) rectangle (1.75,-0.5);
    \draw (3.25,1.5) rectangle (3.75,-0.5);
    \draw (5.25,1.5) rectangle (5.75,-0.5);
  \end{tikzpicture}
\end{figure}
