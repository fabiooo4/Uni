...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    ...
    \draw (b7-2.west) -- ++(-0.5,0) node[above right] {} (b7-2.south) -- ++(0,-0.5);

    \node at (0,-4.3) {\( \vdots \)};

    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (b7-15) at (0,-6) {};
    \draw (b7-15.west) -- ++(-0.5,0) node[above right] {} (b7-15.south) -- ++(0,-0.5);

    \draw (b7.south) -- ++(0,-0.5) (b7.west) -- ++(-0.5,0) node[above right] {\( b_7 \) }
      -- ++(0,-7.8) -- ++(0.5,0) -- ++(0,-0.73);
    ...
    \draw (b6-2.west) -- ++(-0.5,0) node[above right] {} (b6-2.south) -- ++(0,-0.5);

    \node at (2.5,-4.3) {\( \vdots \)};

    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (b6-15) at (2.5,-6) {};
    \draw (b6-15.west) -- ++(-0.5,0) node[above right] {} (b6-15.south) -- ++(0,-0.5);

    \draw (b6.south) -- ++(0,-0.5) (b6.west) -- ++(-0.5,0) node[above right] {\( b_6 \) }
      -- ++(0,-7.8) -- ++(0.5,0) -- ++(0,-0.73);
    ...
    \draw (b0-2.west) -- ++(-0.5,0) node[above right] {} (b0-2.south) -- ++(0,-0.5);

    \node at (6,-4.3) {\( \vdots \)};

    \node[draw, rectangle, minimum width=1cm, minimum height=1cm] (b0-15) at (6,-6) {};
    \draw (b0-15.west) -- ++(-0.5,0) node[above right] {} (b0-15.south) -- ++(0,-0.5);

    \draw (b0.south) -- ++(0,-0.5) (b0.west) -- ++(-0.5,0) node[above right] {\( b_0 \) }
      -- ++(0,-7.8) -- ++(0.5,0) -- ++(0,-0.73);
...
\[
256Mbit \;\; 32Mbit \times 8 = 16K \times 16K
\] 
