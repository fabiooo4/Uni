...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[scale=0.8]
    % F-D-E-W Cycle
    \draw (0,0) rectangle (1.5,1.5) node[midway] {Fetch};
    \draw (3.5,0) rectangle (5,1.5) node[midway] {Decode};
    \draw (7,0) rectangle (8.5,1.5) node[midway] {Execute};
    \draw (10.5,0) rectangle (12,1.5) node[midway] {Write};
    ...
    \draw (2,1.375) -- (3,1.375) node[midway, above, scale=0.8] {IR}; 
    \draw (2,0.75) -- (3,0.75) node[midway, above, scale=0.8] {PC}; 

    \draw (5.5,1.375) -- (6.5,1.375) node[midway, above, scale=0.8] {OP1}; 
    \draw (5.5,0.75) -- (6.5,0.75) node[midway, above, scale=0.8] {OP2}; 
    \draw (5.5,0.125) -- (6.5,0.125) node[midway, above, scale=0.8] {OP3};
    \node[midway, above, scale=0.8] at (5.5,-0.5) {PSW};
