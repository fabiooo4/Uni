...
\subsubsection{Dimostrare che un insieme è ricorsivo}
Per dimostrare che un insieme \( A \) è ricorsivo, si usano i seguenti metodi:
\begin{itemize}
  \item \textbf{Insieme}: Per dimostrare che \( A \) è ricorsivo forniamo l'algoritmo per
    la funzione caratteristica \( f \) 

  \item \( range\;f \): Si costruisce il range:
    \begin{itemize}
